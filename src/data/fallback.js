...
export const siteContentFallback = {
  ...
  package_comparison: {
    title: 'الفرق بين الباقات',
    description: 'نوضح لكِ الفرق بين برامج المتابعة لاختيار الباقة التي تلبي احتياجاتك وأهدافك بدقة',
    card1: {
      title: 'باقات المتابعة العامة / الشهرية',
      description: 'مناسبة لمن ترغب بخطة غذائية واضحة وقوائم متنوعة مع متابعة دورية',
      features: [
        'خطة غذائية متكاملة ومحسوبة السعرات بدقة',
        'خيارات وبدائل متنوعة للوجبات لتجنب الملل',
        'متابعة أسبوعية لمراجعة النتائج والقياسات',
        'إرشادات للتمارين الرياضية ونمط الحياة الصحي'
      ]
    },
    card2: {
      title: 'باقات المتابعة المخصصة والمكثفة (VIP)',
      description: 'مناسبة لمن تحتاج دعماً مستمراً وتعديلات فورية وتواصلاً يومياً ومباشراً',
      features: [
        'خطة غذائية مفصلة حسب تفضيلاتك وحالتك الصحية 100%',
        'تعديل دوري مستمر للخطة حسب استجابة الجسم',
        'متابعة يومية دقيقة للوجبات والالتزام',
        'تواصل واستشارات مباشرة ومستمرة عبر الواتساب الشخصي'
      ]
    }
  },
  cta: {
...
export const packages = [
  ...
  },
  {
    ...
    features: [
      'متابعة يومية حثيثة للوجبات',
      'إرسال صور الوجبات للرصد والتعديل',
      'مرفق مع جدول تمارين وتوجيهات',
  ...
  },
  {
    ...
    features: [
      ...
      'خيارات صحية وبدائل مرنة متنوعة',
      'سبر أداء أسبوعي لتحليل التطور',
  ...
  },
  {
    ...
    features: [
      ...
      'متابعة لصيقة للالتزام النفسي والجسدي',
